...
if ! exists("g:monosert_gui_italic")
    let g:monosert_gui_italic = 0
endif

if ! exists("g:monosert_term_italic")
    let g:monosert_term_italic = 0
endif

let g:monosert_termcolors = 256 " does not support 16 color term right now.
...
function! s:h(group, style)
  ...
  if g:monosert_term_italic == 0
    let s:ctermformat = substitute(s:ctermformat, ",italic", "", "")
    let s:ctermformat = substitute(s:ctermformat, "italic,", "", "")
    let s:ctermformat = substitute(s:ctermformat, "italic", "", "")
  endif
  if g:monosert_gui_italic == 0
    let s:guiformat = substitute(s:guiformat, ",italic", "", "")
    let s:guiformat = substitute(s:guiformat, "italic,", "", "")
    let s:guiformat = substitute(s:guiformat, "italic", "", "")
  endif
  if g:monosert_termcolors == 16
...
let s:palegreen    = { "gui": "#7CCD7C", "cterm": "114" }

let s:pink        = { "gui": "#F92772", "cterm": "197" }
let s:green       = { "gui": "#A6E22D", "cterm": "148" }
let s:aqua        = { "gui": "#66d9ef", "cterm": "81" }
"let s:yellow      = { "gui": "#E6DB74", "cterm": "186" }
let s:yellow      = { "gui": "#EEEE00", "cterm": "226" }
let s:salmon      = { "gui": "#FA8072", "cterm": "210" }
let s:orange      = { "gui": "#FD9720", "cterm": "208" }
let s:purple      = { "gui": "#ae81ff", "cterm": "141" }
let s:red         = { "gui": "#e73c50", "cterm": "196" }
let s:tan         = { "gui": "#FFA54F", "cterm": "215" }
...
call s:h("Cursor",        { "fg": s:black,      "bg": s:yellow })
call s:h("ColorColumn",   {                     "bg": s:lightblack })
call s:h("CursorColumn",  {                     "bg": s:lightblack2 })
call s:h("CursorLine",    {                     "bg": s:lightblack2 })
call s:h("NonText",       { "fg": s:lightgrey })
call s:h("StatusLine",    { "fg": s:palegreen,   "bg": s:black,        "format": "reverse" })
call s:h("StatusLineNC",  { "fg": s:darkgrey,   "bg": s:palegreen,     "format": "reverse" })
call s:h("TabLine",       { "fg": s:white,      "bg": s:darkblack,    "format": "reverse" })
call s:h("Visual",        { "fg": s:black,  "bg": s:tan })
call s:h("Search",        { "fg": s:black,      "bg": s:salmon })
call s:h("MatchParen",    { "fg": s:black,      "bg": s:purple })
call s:h("Question",      { "fg": s:salmon })
call s:h("ModeMsg",       { "fg": s:salmon })
call s:h("MoreMsg",       { "fg": s:salmon })
...
" fold
call s:h("Folded",        { "fg": s:palegreen,   "bg": s:darkblack })
...
call s:h("Character",     { "fg": s:salmon })
call s:h("String",        { "fg": s:salmon })
...
call s:h("Todo",          { "fg": s:salmon,  "bg": s:yellow, "format": "" })
call s:h("Comment",       { "fg": s:palegreen, "format": "" })
...
call s:h("NERDTreeOpenable",        { "fg": s:salmon })
call s:h("NERDTreeClosable",        { "fg": s:salmon })
call s:h("NERDTreeHelp",            { "fg": s:salmon })
call s:h("NERDTreeBookmarksHeader", { "fg": s:pink })
call s:h("NERDTreeBookmarksLeader", { "fg": s:black })
call s:h("NERDTreeBookmarkName",    { "fg": s:salmon })
...
call s:h("jsFuncArgRest",       { "fg": s:purple, "format": "" })                                 
call s:h("jsFuncArgs",          { "fg": s:orange, "format": "" })
call s:h("jsStorageClass",      { "fg": s:aqua })
call s:h("jsDocTags",           { "fg": s:aqua,   "format": "" })
...
" CSS
call s:h("cssProp",             { "fg": s:salmon })
call s:h("cssUIAttr",           { "fg": s:salmon })
...
call s:h("rubyStringDelimiter",         { "fg": s:salmon })
call s:h("rubyRegexp",                  { "fg": s:salmon })
call s:h("rubyRegexpDelimiter",         { "fg": s:salmon })
